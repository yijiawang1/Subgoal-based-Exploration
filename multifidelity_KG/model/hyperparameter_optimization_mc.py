...
def covariance(hyper_without_noise, lengths_sq_0, point_one, point_two): 
    ...
    ker_s = hyper_without_noise[-4] + hyper_without_noise[-3] * point_two[0] + \
            hyper_without_noise[-2] * point_two[0] + hyper_without_noise[-1] * point_two[0] * point_two[0]
    # print(point_two[0])
    # -------------------- Matern52 -------------------- #
    norm_x_sq = numpy.divide( numpy.power(point_two[1:] - point_one[1:], 2.0), lengths_sq_0[:2] ).sum()
